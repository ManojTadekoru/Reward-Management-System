...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("RewardPoliciesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheRewardPoliciesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheRewardPoliciesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheRewardPoliciesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheRewardPoliciesListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheRewardPoliciesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheRewardPoliciesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheRewardPoliciesListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheRewardPoliciesObjectPageGenerated.iSeeThisPage();
        });
