sap.ui.define([
    ...
    return ControllerExtension.extend(
        "customers.ext.controller.CustomerObjectPage",
        {
            ...
            // REDEEM POINTS
            // =====================================================
            // NOTE: FE calls header/section action handlers via
            // FPMHelper.actionWrapper with the binding context
            // directly as the first argument (or an array of
            // contexts for table/list-row actions) -- NOT a UI5
            // event object. Do not use oEvent.getSource() here.
