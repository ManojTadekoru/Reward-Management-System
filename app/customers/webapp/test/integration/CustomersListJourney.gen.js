...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheCustomersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheCustomersListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheCustomersListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheCustomersListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheCustomersListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheCustomersListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheCustomersListGenerated.onTable(defaultTableId).iPressRow(0);
